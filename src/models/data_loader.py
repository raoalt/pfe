...
class Batch(object):
    ...
    def __init__(self, data=None, device=None, is_test=False):
        ...
        if data is not None:
            ...
            pre_clss_ancien = [x[3] for x in data]
            pre_clss = [[i for i in range(len(x[3]))] for x in data]
...
#            print("pre_clss ancien :", pre_clss_ancien)
 #           print("pre_clss :", pre_clss)
            ...
            setattr(self, 'mask_src_txt', None)
            setattr(self, 'mask_tgt_txt', None)
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        if(is_test):
            ...
            return src, tgt, segs, clss, src_sent_labels, src_txt
